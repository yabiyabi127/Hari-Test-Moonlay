...
import { getPlanet, getPlanetsById, getStarships, getStarshipsByid } from "../../redux/action";
...
const Starships = () => { 
  ...
  function openModal(data) {
    setIsOpen(true);
    dispatch(getStarshipsByid(data))
  }
  const dispatch = useDispatch();
  const { starships, starshipsbyid} = useSelector((state) => state.extraData);
                      ...
                      >
                        <Dialog.Panel className="w-full max-w-xl transform overflow-hidden rounded-2xl bg-white p-10 text-left align-middle shadow-xl transition-all">
                          ...
                          <div className="mt-2 flex mb-2">
                            ...
                            <p className="text-md text-gray-700">
                              {starshipsbyid.max_atmosphering_speed}
                            </p>
                          </div>
                          <div className="mt-2 flex mb-2">
                            <span className="text-md text-gray-800">
